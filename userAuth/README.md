...
- ## `action.php`
  you are expected to edit the switch case statement to unpack the verious credentials that is passed from the form, either using the $_POST, $_GET, $_SESSION...
